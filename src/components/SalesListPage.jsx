...
function SalesPageRoute() {
  ...
  useEffect(() => {
    const fetchBestProducts = async () => {
      try {
        const response = await fetch("https://wmk-backend.onrender.com/api/user_product/products/section?productPlace=sales");
